...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20190505-noroom">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20190505-noroom/",
      "url": "http://static.startribune.com/news/projects-staging/all/20190505-noroom/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20190505-noroom/",
      "url": "http://static.startribune.com/news/projects/all/20190505-noroom/"
    }
  }
}
```
